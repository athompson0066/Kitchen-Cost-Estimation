...
Please generate the estimate now.
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 font-sans text-slate-900 dark:text-slate-100 selection:bg-orange-200">
      ...
      <div className="pt-20 px-8 max-w-7xl mx-auto opacity-50 pointer-events-none">
        <header className="flex justify-between items-center mb-24">
          ...
          <div className="flex gap-8">
            {[1,2,3,4].map(i => <div key={i} className="w-16 h-4 bg-slate-200 dark:bg-slate-800 rounded"></div>)}
          </div>
        </header>

        <main className="grid grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <div className="w-3/4 h-16 bg-slate-200 dark:bg-slate-800 rounded-xl"></div>
            <div className="w-full h-16 bg-slate-200 dark:bg-slate-800 rounded-xl"></div>
            <div className="w-full h-32 bg-slate-200 dark:bg-slate-800 rounded-xl mt-8"></div>
            <div className="w-48 h-12 bg-slate-300 dark:bg-slate-700 rounded-full mt-8"></div>
          </div>
